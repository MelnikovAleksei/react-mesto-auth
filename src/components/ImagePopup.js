...
function ImagePopup(props) {
  return (
    <div className={`popup popup-photos ${props.card && 'popup_opened'}`}>
      <div className="popup__container popup-photos__container">
        ...
        <button onClick={props.onClose} className="popup__close-button" aria-label="закрыть просмотр фотографии"></button>
      </div>
    </div>
  )
}
